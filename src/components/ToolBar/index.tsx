...
import { setShapes, deleteShape, editActiveShape, deleteArrow } from '../../store/shapes/actions';
		...
		return (
			<div className="toolbar">
				...
				<div className="left-side">
					...
					{
						(this.props.shapes.sourceArrow || this.props.shapes.sourceShape) &&
						<OverlayTrigger
							overlay={<Tooltip id="tooltip-download-svg">Delete selected layer/arrow</Tooltip>}
							placement="bottom"
						>
							<button onClick={this.handleDeleteSelection}>
								<svg viewBox="5 7 15 15" width="24" height="24"><path d="M16,11 L16,7 L7,7 L7,17 C7,18.104 7.896,19 9,19 L11,19 L11,20 L9,20 C7.343,20 6,18.657 6,17 L6,7 L5,7 L5,6 L9,6 L9,5 C9,4.44771525 9.44771525,4 10,4 L13,4 C13.5522847,4 14,4.44771525 14,5 L14,6 L18,6 L18,7 L17,7 L17,11 L16,11 Z M10,5 L10,6 L13,6 L13,5 L10,5 Z M16.4983444,15.7913331 L19.1416786,13.1463165 C19.3369408,12.9510544 19.6535233,12.9510544 19.8487854,13.1463165 C20.0440475,13.3415787 20.0440475,13.6581612 19.8487854,13.8534233 L17.2052263,16.4986649 L19.8487854,19.1439064 C20.0440475,19.3391685 20.0440475,19.655751 19.8487854,19.8510132 C19.6535233,20.0462753 19.3369408,20.0462753 19.1416786,19.8510132 L16.4983444,17.2059967 L13.8550102,19.8510132 C13.6597481,20.0462753 13.3431656,20.0462753 13.1479034,19.8510132 C12.9526413,19.655751 12.9526413,19.3391685 13.1479034,19.1439064 L15.7914625,16.4986649 L13.1479034,13.8534233 C12.9526413,13.6581612 12.9526413,13.3415787 13.1479034,13.1463165 C13.3431656,12.9510544 13.6597481,12.9510544 13.8550102,13.1463165 L16.4983444,15.7913331 Z"></path></svg>
							</button>
						</OverlayTrigger>
					}
				</div>
				...
				<div className="right-side">
					...
					>
						<Form style={{float: "left", marginTop: "1px", marginRight:"-10px"}}>
							<Form.Check 
								...
								onChange={this.handleStyleTemplate}
								type="switch"
								id="custom-switch"
								label=""
							/>
					...
					<OverlayTrigger
						...
						placement="bottom"
					>
						<button onClick={this.toggleFullScreen} id="fullscreen-mode">
					...
					<a href="https://github.com/danielpaz6/NNBuilder">
						<OverlayTrigger
							overlay={<Tooltip id="tooltip-github">This project is open source!</Tooltip>}
							placement="bottom"
						>
							<button>
...
export default connect(
	mapStateToProps,
	{ setShapes, updateDesignTemplate, deleteShape, editActiveShape, deleteArrow }
)(ToolBar);